...
def getDNASum(s1,s2):
    ...
    for i in range(4):
        if (s1[i] == 'A' and s2[i] == 'A') or (s1[i] == 'T' and s2[i] == 'C') or (s1[i] == 'G' and s2[i] == 'G') or (s1[i] == 'C' and s2[i] == 'T'):
            k+='A'
        elif (s1[i] == 'C' and s2[i] == 'C') or (s1[i] == 'T' and s2[i] == 'T') or (s1[i] == 'A' and s2[i] == 'G') or (s1[i] == 'G' and s2[i] == 'A'):
            k+= 'G'
        elif (s1[i] == 'A' and s2[i] == 'C') or (s1[i] == 'C' and s2[i] == 'A') or (s1[i] == 'G' and s2[i] == 'T') or (s1[i] == 'T' and s2[i] == 'G'):
            k+= 'C'
        elif (s1[i] == 'A' and s2[i] == 'T') or (s1[i] == 'T' and s2[i] == 'A') or (s1[i] == 'C' and s2[i] == 'G') or (s1[i] == 'G' and s2[i] == 'C'):
            k+= 'T'
    return k
...
def getDiffusedImage(img,key):
    ...
    for c in range(65536):
        ...
        x = getDNASum(str(bin_arr[c]),str(bin_arr_key[c]))
        x = decodeDNA(x)
